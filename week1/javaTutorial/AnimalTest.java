...
class AnimalTest {
   ...
   public static void main(String[] args) {
      ...
      a.talk();
      //a.fly();
      /* fly() is created in the class bird. a is not of the class bird, b
      but of the class animal. So it doesn't have a method fly()*/
      ...
      b.talk();
      //b.attack(); 
      /*variable numberOfKills and method attack() are created in eagle. 
      b is not an eagle. */
